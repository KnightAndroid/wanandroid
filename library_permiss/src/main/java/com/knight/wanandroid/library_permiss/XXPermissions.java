...
public final class XXPermissions {
    ...
    /** 权限请求拦截器 **/
    private static IPermissionInterceptor iPermissionInterceptor;
    /** 调试模式 **/
     ...
     * 设置请求的对象
     *
     * @param context          当前 Activity，也可以传入栈顶的 Activity
     */
    ...
    static IPermissionInterceptor getPermissionInterceptor() {
        if (iPermissionInterceptor == null) {
            iPermissionInterceptor = new IPermissionInterceptor() {};
        }
    ...
    public void request(OnPermissionCallback callback) {
        ...
        // 检查当前 Activity 状态是否正常，如果不正常就不清求权限
