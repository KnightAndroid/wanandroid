...
import com.knight.wanandroid.library_util.ActivityStack;
 ...
 * @descript:
 */
public class ToastStrategy extends Handler implements ToastStrategyInterface {
    ...
    /** Toast 对象 */
    private WeakReference<ToastInterface> mToastReference;

    /** Toast 样式 */
    private ToastStyleInterface<?> mToastStyle;
    ...
    @Override
    public void bindStyle(ToastStyleInterface<?> style) {
        mToastStyle = style;
    }

    @Override
    public ToastInterface createToast(Application application) {
