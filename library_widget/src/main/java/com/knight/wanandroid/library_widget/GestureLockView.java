...
public class GestureLockView extends View {
    ...
    private boolean setOneGesturePassword = false;
    private boolean setTwoGesturePassword = false;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        dotRadius = a.getDimensionPixelSize(R.styleable.GestureLockView_dot_radius,
                getResources().getDimensionPixelSize(R.dimen.widget_gesture_default_dot_radius));
        ...
        lineWidth = a.getDimensionPixelSize(R.styleable.GestureLockView_line_width,
                getResources().getDimensionPixelSize(R.dimen.widget_gesture_default_line_width));
        ...
        dotPressedRadius = a.getDimensionPixelSize(R.styleable.GestureLockView_dot_pressed_radius,
                getResources().getDimensionPixelSize(R.dimen.widget_gesture_default_dot_pressed_radius));
    ...
    private void resetStatus() {
        ...
        if (password.toString().length() < minLength) {
            ...
            //这里判断是录入还是校验密码
            if (mOnSetPasswordListener != null) {
                if (setOneGesturePassword && mOnSetPasswordListener.setOnCheckPassword(password.toString())) {
                    setTwoGesturePassword = true;
                    mOnSetPasswordListener.setTwoGesturePassword(password.toString());
                    ToastUtils.show(R.string.widget_gesture_password_success);
                } else {
                ...
                if (!setOneGesturePassword) {
                    ...
                    ToastUtils.show(R.string.widget_gesture_password_again);
                }
            } else {
                //密码长度符合要求
    ...
    public void setPasswordListener(OnSetPasswordListener mOnSetPasswordListener) {
    ...
    public interface OnSetPasswordListener {
        void setOneGesturePassword(String onePassword);
        void setTwoGesturePassword(String twoPassword);
        boolean setOnCheckPassword(String passwd);
