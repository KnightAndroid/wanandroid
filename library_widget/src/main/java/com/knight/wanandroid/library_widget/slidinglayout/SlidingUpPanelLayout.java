package com.knight.wanandroid.library_widget.slidinglayout;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.widget_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.widget_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
